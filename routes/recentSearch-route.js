...
router.delete("/deleteRecentSearches", checkLoggedIn, recentSearchController.deleteRecentSearches); // 유저 인덱스 따른 최근 검색어 및 검색한 주식 전부 삭제
router.delete("/deleteRecentSearchesItem", checkLoggedIn, recentSearchController.deleteRecentSearchesItem); // 유저 인덱스 따른 최근 검색어 개별 삭제
